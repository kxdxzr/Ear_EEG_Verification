...
path = "Z:/data_collected/dragonfly/4.7mm/Cai/ASSR3537404345_2023-09-25_17-03-21.bdf"
...
EEG_data = load_EEG_all_channels(path, BPFfc = [32,47])
EEG_data = mean_and_replace(EEG_data, channel_number)
EEG_data = extract_arrays(EEG_data,[3,6])

STFT(sampling_rate,time, last, EEG_data,[32,47])
